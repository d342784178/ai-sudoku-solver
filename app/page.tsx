...
import VersionTable from "@/app/ui/version";
                ...
                <div className="mx-auto w-full max-w-7xl px-4 mt-12 md:mt-24">
                    <div className="mx-auto w-full max-w-6xl text-center">
                        ...
                        <p className="mt-4 mb-4 md:mt-12 md:mb-8 text:lg md:text-4xl">
                            build in public with <span className="text-primary font-bold">you</span>
                            <a href="https://github.com/all-in-aigc/gpts-works/issues/5" target="_blank"
                               className="text-sm text-primary mx-2">Submit yours 👉</a>
                        </p>
                    </div>
                </div>
